...
# Function to simplify weather description
...
def get_weather(city):
    api_key = "b50a82b519bf1a64077c94d7433aadf9"
  ...
  # 🔴 Replace this with your real API key
    ...
    if response.status_code == 200:
        ...
        # Colored weather output
        print(Back.YELLOW + Fore.BLACK + f"\n📍 Weather Report for {city.title()}:\n")
        print(Back.CYAN + Fore.BLACK + f"🌡️ Temperature: {temp}°C")
        print(Back.MAGENTA + Fore.WHITE + f"💧 Humidity: {humidity}%")
        print(Back.BLUE + Fore.WHITE + f"🌥️ Condition: {weather_desc}")
        print(Back.GREEN + Fore.BLACK + f"🌬️ Wind Speed: {wind_speed} m/s")
        print(Back.RED + Fore.WHITE + f"\n🗣️ Easy Info: {simple_message}\n")

        speak(simple_message)
    
    else:
        # 🔴 This part prints the error details clearly
...
# Ask user for city and run the program
...
>>>>>>> 2ceda519c024b3c8ae2114b445089141122d0b00
